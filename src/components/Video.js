    ...
    <>
      <span className="align-middle">
        {data
          ...
          .map((dataTrailer, index) =>
            index < 1 && dataTrailer ? (
              <a
                className="ms-3 aLink text-dark"
                key={index}
                href={"https://www.youtube.com/watch?v=" + dataTrailer.key}
                target="_blank"
                rel="noreferrer"
              >
                <IoPlay className="me-2 mb-1 text-dark" />
                Play trailer
              </a>
            ) : null
          )}
                ...
                <div className="card-body">
                  <div className="card-text">
                    ...
                    <div className="text-break">
                      {dataRow.name ? dataRow.name : dataRow.title}
                    </div>
                  </div>
                </div>
              </div>
