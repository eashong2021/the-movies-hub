...
import { API_KEY, POSTER_PATH, WIDTH_500, API_TV } from '../constant';
                ...
                <div className="card frameWidth" key={index}>
                  ...
                  <div className="card-body">
                    <div className="card-text">
                      <div className='text-muted'>{(`${dataRow.air_date}`).substring(0, 4) !== 'unde' ? (`${dataRow.air_date}`).substring(0, 4) : 'Date not defined'}</div>
